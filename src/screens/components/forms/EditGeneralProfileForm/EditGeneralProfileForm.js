  ...
  React.useEffect(() => {
    if (editData) {
      reset(formValues => ({
        ...
        city: editData?.city || '',
        salaryMin: (editData?.salaryMin || 0).toString(),
        salaryMax: (editData?.salaryMax || 0).toString(),
...
EditGeneralProfileForm.Loading = Loading;

export default EditGeneralProfileForm;
