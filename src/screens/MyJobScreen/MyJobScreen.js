...
import JobPostSavedCard from '../components/JobPostSavedCard';
import JobPostAppliedCard from '../components/JobPostAppliedCard';
        ...
        {isLayoutLoading ? (
          ...
          <>
            <View flex={9}>
              {tab === 0 ? (
                <>
                  {/* Start: JobPostSavedCard */}
                  <JobPostSavedCard />
                  {/* End: JobPostSavedCard */}
                </>
              ) : (
                <>
                  {/* Start: JobPostAppliedCard */}
                  <JobPostAppliedCard />
                  {/* End: JobPostAppliedCard */}
                </>
              )}
            </View>
